...
var RecipeDetailComponent = /** @class */ (function () {
    function RecipeDetailComponent(recipeService, route, router, authService) {
...
var RecipeEditComponent = /** @class */ (function () {
    ...
    RecipeEditComponent.prototype.initForm = function () {
        ...
        var recipeIngridients = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormArray"]([]);
        if (this.editMode) {
            ...
            if (recipe['ingridients']) {
                for (var _i = 0, _a = recipe.ingridients; _i < _a.length; _i++) {
                    var ingridient = _a[_i];
                    recipeIngridients.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
                        'name': new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](ingridient.name, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                        'amount': new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](ingridient.amount, [
        ...
        this.recipeForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            ...
            'imagePath': new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](reeipeImagePath, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
    ...
    RecipeEditComponent.prototype.onAddIngridient = function () {
        this.recipeForm.get('ingridients').push(new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
    ...
    RecipeEditComponent.prototype.onRemoveIngridient = function (index) {
        this.recipeForm.get('ingridients').removeAt(index);
    };
...
var RecipeItemComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('recipe-item'),
...
var RecipeListComponent = /** @class */ (function () {
    ...
    RecipeListComponent.prototype.onCreateNewRecipe = function () {
...
module.exports = "<h3>Please Select recipe</h3>\n"
...
var recipesRoutes = [
    { path: '', component: _recipes_component__WEBPACK_IMPORTED_MODULE_2__["RecipesComponent"], children: [
            ...
            { path: 'new', component: _recipe_edit_recipe_edit_component__WEBPACK_IMPORTED_MODULE_4__["RecipeEditComponent"], canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
            { path: ':id', component: _recipe_detail_recipe_detail_component__WEBPACK_IMPORTED_MODULE_6__["RecipeDetailComponent"] },
            { path: ':id/edit', component: _recipe_edit_recipe_edit_component__WEBPACK_IMPORTED_MODULE_4__["RecipeEditComponent"], canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] }
        ] }
];
var RecipesRoutingModule = /** @class */ (function () {
    ...
    RecipesRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]]
        })
