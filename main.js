...
module.exports = "<app-header></app-header>\n<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <!-- <app-recipes *ngIf=\"navigateTo==='recipe'\"></app-recipes>\n      <app-shopping-list *ngIf=\"navigateTo==='shopping-list'\"></app-shopping-list> -->\n      <router-outlet></router-outlet>\n    </div>\n  </div>\n</div>\n\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onNavigate = function (event) {
...
/* harmony import */ var _app_routemodule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app.routemodule */ "./src/app/app.routemodule.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _app_routemodule__WEBPACK_IMPORTED_MODULE_4__["AppRouteModule"],
...
var routes = [
    ...
    { path: 'shoppinglist', component: _shopping_list_shopping_list_component__WEBPACK_IMPORTED_MODULE_2__["ShoppingListComponent"] }
];
...
var AuthRoutingModule = /** @class */ (function () {
    ...
    AuthRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(authRouts)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
        })
    ], AuthRoutingModule);
...
var CoreModule = /** @class */ (function () {
    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_shopping_list_shopping_list_service__WEBPACK_IMPORTED_MODULE_5__["ShoppingListService"], _recipes_recipe_service__WEBPACK_IMPORTED_MODULE_6__["RecipeService"], _shared_data_storage_service__WEBPACK_IMPORTED_MODULE_7__["DataStorageService"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"]]
        })
    ], CoreModule);
    return CoreModule;
}());
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.onSaveData = function () {
        this.dataStorage.storeRecipes().subscribe(function (response) { return console.log(response); });
    };
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_shared_data_storage_service__WEBPACK_IMPORTED_MODULE_1__["DataStorageService"],
...
var Recipe = /** @class */ (function () {
    function Recipe(name, desc, imagePath, ingredient) {
        this.name = name;
...
var RecipeService = /** @class */ (function () {
    function RecipeService(shoppingListService) {
        ...
        this.recipes = [
            new _recipe_model__WEBPACK_IMPORTED_MODULE_1__["Recipe"]('pizza', 'this is pizza', 'https://cdn.pixabay.com/photo/2017/11/08/15/34/recipe-2930786_960_720.jpg', [
            ...
            new _recipe_model__WEBPACK_IMPORTED_MODULE_1__["Recipe"]('Burger', 'this is Burger', 'https://cdn.pixabay.com/photo/2017/11/08/15/34/recipe-2930786_960_720.jpg', [
                new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]('meat', 1),
    ...
    RecipeService.prototype.addIngridientsToShoppingList = function (ingredients) {
        this.shoppingListService.setIngridients(ingredients);
    };
    RecipeService.prototype.getRecipe = function (index) {
        return this.recipes[index];
    };
    RecipeService.prototype.addRrecipe = function (recipe) {
...
var DataStorageService = /** @class */ (function () {
    ...
    DataStorageService.prototype.storeRecipes = function () {
        ...
        return this.http.put('https://ng-recipe-book-6e939.firebaseio.com/recipes.json?auth=' + token, this.recipeService.getRecipes());
    };
    DataStorageService.prototype.fetchRecipes = function () {
        ...
        this.http.get('https://ng-recipe-book-6e939.firebaseio.com/recipes.json?auth=' + token)
            ...
            console.log(res);
            _this.recipeService.setRecipes(res);
        });
    };
...
var ShoppingEditComponent = /** @class */ (function () {
    ...
    ShoppingEditComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.shoppingListService.startedEditing.subscribe(function (index) {
            ...
            _this.editMode = true;
            _this.editedItem = _this.shoppingListService.getIngridient(index);
            _this.form.setValue({
    ...
    ShoppingEditComponent.prototype.onSubmit = function () {
        var value = this.form.value;
        var ingredient = new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_1__["Ingredient"](value.name, value.amount);
        if (this.editMode) {
...
var ShoppingListComponent = /** @class */ (function () {
    ...
    ShoppingListComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.shoppingListService.ingridientsChanged.subscribe(function (changedIngredients) {
            _this.ingredients = changedIngredients;
        });
    };
...
var ShoppingListService = /** @class */ (function () {
    function ShoppingListService() {
        this.ingridientsChanged = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        ...
        this.ingredients = [
            ...
            new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_0__["Ingredient"]("Tomato", 5),
        ];
    }
    ShoppingListService.prototype.getIngridients = function () {
        return this.ingredients.slice();
    };
    ShoppingListService.prototype.getIngridient = function (index) {
        return this.ingredients[index];
    };
    ShoppingListService.prototype.addIngridient = function (ingredient) {
    ...
    ShoppingListService.prototype.setIngridients = function (ingridients) {
        var _a;
        (_a = this.ingredients).push.apply(_a, ingridients);
        this.ingridientsChanged.next(this.ingredients.slice());
    };
    ShoppingListService.prototype.updateIngridient = function (index, newIngridient) {
        this.ingredients[index] = newIngridient;
        this.ingridientsChanged.next(this.ingredients.slice());
    };
    ShoppingListService.prototype.deleteIngridient = function (index) {
...
module.exports = __webpack_require__(/*! F:\Angular\shop\src\main.ts */"./src/main.ts");
